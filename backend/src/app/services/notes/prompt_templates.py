...
def build_final_prompt(transcript: str, student_notes: str = "") -> str:
    ...
    return (
        ...
        "- Include one mermaid fenced block only when a process, relationship, or sequence truly benefits from a diagram\n"
        "- Mermaid must use simple ASCII-safe labels only; no LaTeX, unicode arrows, escaped newlines, or special symbols inside node labels\n"
